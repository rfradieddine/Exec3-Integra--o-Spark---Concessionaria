...
public class ProdutoService {
	...
	public void makeForm(int tipo, Produto produto, int orderBy) {
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umProduto += "\t\t\t<td>Ano/modelo: <input class=\"input--register\" type=\"text\" name=\"dataValidade\" value=\""+ produto.getDataValidade().toString() + "\"></td>";
			...
			umProduto += "\t\t\t<td>Ano/Modelo: "+ produto.getDataValidade().toString() + "</td>";
			umProduto += "\t\t\t<td>&nbsp;</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";		
		} else {
